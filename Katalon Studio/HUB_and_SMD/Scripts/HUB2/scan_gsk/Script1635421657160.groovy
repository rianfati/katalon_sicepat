...
WebUI.click(findTestObject('Object Repository/HUB2/scan_gsk/Page_TMS/a_Scan Masuk Gsk BaggingScan Masuk Gsk Bagging'))

WebUI.setText(findTestObject('Object Repository/HUB2/scan_gsk/Page_TMS/input_Memuat Data _p-inputtext p-component _83c38e'), 
    bag_number)

WebUI.sendKeys(findTestObject('Object Repository/HUB2/scan_gsk/Page_TMS/input_Memuat Data _p-inputtext p-component _83c38e'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/HUB2/scan_gsk/Page_TMS/span_Selanjutnya'))

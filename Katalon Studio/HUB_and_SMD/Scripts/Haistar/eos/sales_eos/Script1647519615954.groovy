...
WebUI.setText(findTestObject('Object Repository/eos/sales/eos_sales_detail_item_code_qty'), '12')
...
WebUI.setText(findTestObject('Object Repository/eos/sales/eos_sales_detail_item_code_qty'), '13')

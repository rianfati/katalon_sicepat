...
WebUI.click(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/a_Scan Masuk Gabung PaketScan Masuk Gabung Paket'))

WebUI.setText(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/input_concat(Scan atau Tekan tombol   Selan_d81960'), 
    bag_number)

WebUI.click(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/span_Selanjutnya'))

WebUI.click(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/span_Selesai'))

WebUI.setText(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/input_p-btn_p-inputtext p-component'), 
    bag_number)

WebUI.click(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/span_p-btn_pi pi-search p-c p-button-icon-left'))

WebUI.click(findTestObject('Object Repository/HUB2/scan_gab_paket_smd/Page_TMS/td_DO_LINEHAUL'))
